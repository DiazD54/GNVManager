  ...
  return (
    <div className="brutal-card flex flex-col h-full bg-white">
      <div className="flex items-center gap-4 border-b-4 border-black pb-6 mb-8">
        <div className="bg-black p-3 shadow-[4px_4px_0px_0px_rgba(200,200,200,1)]">
          <History className="w-8 h-8 text-white stroke-[3px]" />
        </div>
        <div>
      ...
      <div className="flex-1 overflow-y-auto pr-4 space-y-8">
        {records.length === 0 ? (
          <div className="text-center bg-[#f4f4f5] border-4 border-black p-10 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            ...
            return (
              <div key={record.id} className="bg-white border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] p-6">
                ...
                {!hasSale ? (
                  ...
                  <div className={`mt-6 p-4 border-4 border-black flex items-center justify-between ${isWarning ? 'bg-[#FF4500] text-white' : 'bg-[#00FF7F] text-black'} shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]`}>
                    <div className="flex items-center gap-4">
                      <div className="bg-white p-2 border-2 border-black">
                        {isWarning ? <AlertTriangle className="w-6 h-6 text-black stroke-[3px]" /> : <CheckCircle2 className="w-6 h-6 text-black stroke-[3px]" />}
                      </div>
                      <div>
                    ...
                    <div className="text-right bg-white text-black border-2 border-black px-4 py-2">
